      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 order-2 lg:order-1">
            ...
            >
              Truyền Lửa Đam Mê & Khởi Nghiệp Cùng PMU
            </motion.h2>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <p>
                Khóa học Permanent Makeup chuyên nghiệp từ cơ bản đến nâng cao. Đào tạo 1 kèm 1 hoặc nhóm nhỏ, đảm bảo chất lượng đầu ra.
              </p>
              <ul className="space-y-4 text-white">
                <li className="flex items-center gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                  <span>Kỹ thuật phun mày, môi, mí chuẩn Châu Âu</span>
                </li>
                <li className="flex items-center gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                  <span>Hỗ trợ setup studio và chiến lược Marketing</span>
                </li>
                <li className="flex items-center gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary" />
                  <span>Cấp chứng chỉ hành nghề chuẩn quốc gia</span>
                </li>
              </ul>
            </motion.div>
            <motion.div
