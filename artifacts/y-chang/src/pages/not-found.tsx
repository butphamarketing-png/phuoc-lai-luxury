...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background pt-24">
      <Card className="w-full max-w-md mx-4 rounded-[2rem] border-border/60">
        <CardContent className="pt-8 pb-8 text-center">
          <AlertCircle className="h-10 w-10 text-foreground/30 mx-auto mb-4" />
