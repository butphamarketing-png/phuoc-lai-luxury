...
--
-- Chỉ cập nhật slug: sandbrows (phun-may-sandbrows = AMAZINGBROWS for men)
-- Nếu chưa có bài sandbrows, chạy seed-sandbrows-service.sql trước.

update public.site_services
set
  detail_json = coalesce(detail_json, '{}'::jsonb) || jsonb_build_object(
